...
class Jet(pygame.sprite.Sprite):
    ...
    def __maintain_boundary(self):
        ...
        if self.rect.bottom > self.__game_env.constants.screen_height - self.__game_env.vegetation_size[1]/2:
            self.rect.bottom = self.__game_env.constants.screen_height - self.__game_env.vegetation_size[1]/2   # if the jet has moved bottom and have crossed the screen; the bottom position is set to screen width as it is the boundary
