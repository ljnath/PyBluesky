...
class Missile(pygame.sprite.Sprite):
    ...
    def __init__(self, game_env):
        ...
        pos_x = random.randint(self.__game_env.constants.screen_width + 10, self.__game_env.constants.screen_width + 60)# generating random x position
        pos_y = random.randint(0, self.__game_env.constants.screen_height - self.__game_env.vegetation_size[1] / 2)     # generating random y position
