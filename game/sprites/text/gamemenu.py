...
class GameMenuText(Text):
    ...
    """
    def __init__(self): 
        Text.__init__(self, size=36)                                                                          # initilizing parent class with default text color as red
        ...
        start_game_surface = self.font.render(f' {start_game_text}', 1, self.__game_env.static.text_selection_color)                                                # creating surface with Start Game text when highlighted
        ...
        exit_surface = self.font.render(f' {exit_text}', 1, self.__game_env.static.text_selection_color)                                                        # creating surface with Exit text when highlighted
        self.__exit_selected = Surface((self.__jet.surf.get_width() + exit_surface.get_width(), exit_surface.get_height()), self.__game_env.SRCALPHA)           # creating surface for jet and highlighted Exit text
