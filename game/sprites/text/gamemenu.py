...
class GameMenuText(Text):
    ...
    def update(self, pressed_keys):
        ...
        self.rect = self.surf.get_rect(center=(self.__game_env.constants.screen_width/2, self.__game_env.constants.screen_height/2 + 50))        # creating default rect and setting its position center
