...
class HelpText(Text):
    ...
    def __init__(self): 
        ...
        all_surfaces.append(seperator)
        all_surfaces.append(self.font.render('During menu screen, ove your device horizontally and vertically to select options in menu and', 1, self.color))
        all_surfaces.append(self.font.render('tap on screen to confirm. During gameplay, move your device horizontally and vertically to control', 1, self.color))
        all_surfaces.append(self.font.render('the jet and tap on the screen to shoot', 1, self.color))
