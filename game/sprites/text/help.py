...
class HelpText(Text):
    ...
    def __init__(self, game_env): 
        ...
        all_surfaces.append(seperator)
        all_surfaces.append(self.font.render('With keyboard input, you should use your keyboard arrow keys to navigate your jet and spacebar to shoot.', 1, self.color))
        all_surfaces.append(self.font.render('With mouse as input, you should use your mouse to navigate your jet and  mouse click to shoot', 1, self.color))
