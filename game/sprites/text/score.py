...
class ScoreText(Text):
    ...
    def update(self):
        ...
        self.surf = self.font.render("LEVEL {} TIME {} AMMO {} SCORE {}".format(str(game_env.dynamic.game_level).zfill(2), str(game_env.dynamic.game_playtime).zfill(5), str(game_env.dynamic.ammo).zfill(3),str(game_env.dynamic.game_score).zfill(8)), 1, self.color)
